              ...
              messages.map((msg, index) => {
                ...
                return (
                  <MessageItem
                    ...
                    senderUsername={participantMap.get(msg.senderId)?.user?.username || "?"}
                    replyToMessageContent={msg.replyToId ? messageMap.get(msg.replyToId)?.content : undefined}
                    replyToSenderUsername={msg.replyToId && messageMap.get(msg.replyToId) ? participantMap.get(messageMap.get(msg.replyToId)!.senderId)?.user?.username : undefined}
                    canDelete={isMe || participantMap.get(user?.id)?.role !== "MEMBER"}

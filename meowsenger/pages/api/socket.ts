    ...
    socket.on(
      ...
      async (data: {
        ...
        try {
          ...
          // ⚡ Bolt: Wrapped sequential related database updates into a single Prisma transaction to reduce I/O latency by consolidating multiple database round-trips.

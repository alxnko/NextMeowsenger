...
function getDependencies() {
  // Current code dependencies: [socket, isConnected, chatId, user, privateKey, messages]
  return [socket, isConnected, chatId, user, privateKey, messages];
}
...
// SIMULATION LOOP
console.log("Simulating 100 incoming messages with current dependency array...");
...
if (listenerSetupCount > 50) {
    console.log("⚠️  BASELINE ESTABLISHED: Excessive re-subscriptions detected.");
} else {
